...
function export_ace_tests(fname::AbstractString, V, ntests = 1;
                          nrepeat = 1, pert=0.0)
   at = IPFitting.Data.read_xyz("/Users/Cas/gits/ACE.jl/src/export/bulk.xyz", energy_key="", force_key="", virial_key="")[1].at * nrepeat
...
export_ace_tests("/Users/Cas/gits/ACE.jl/src/export/Al_basic_N2", IP)
...
# IP = read_dict(load_dict("./src/export/HMD_TiAl_Ti_Al_all_B3_N2_3.json")["IP"])

# at = IPFitting.Data.read_xyz("/Users/Cas/gits/ACE.jl/src/export/bulk.xyz", energy_key="", force_key="", virial_key="")[1].at * 1
# JuLIP.set_pbc!(at, false)
...
# export_ACE("./src/export/HMD_TiAl_Ti_Al_all_B3_N2_3.yace", IP)

# energy(IP.components[1], at)
# energy(IP.components[2], at)
# energy(IP.components[3], at)
...
# string.(chemical_symbol.(groups[6]["zs"]))

# groups[6]["zs"]


# length(vcat(groups[4]["M"]...))
# ff
# ##
...
# ACE.Export.export_ace("./src/export/Al_basic_N2.ace", IP.components[3], IP.components[2], IP.components[1])
