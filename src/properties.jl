...
for (E,Val_E) = zip((:EuclideanMatrix,:SymmetricEuclideanMatrix, :AntiSymmetricEuclideanMatrix) ,
                  (:(Val{:ACE_EuclideanMatrix}),:(Val{:ACE_SymmetricEuclideanMatrix}),:(Val{:ACE_AntiSymmetricEuclideanMatrix})) )
   eval(
      quote
